		...
		<div class="row full-banner">
			...
			<div class="col-md-7 md-7 banner-details">
				...
				<div class="banner-button">
					<a href=""><span class="btn btn-primary banner-b1">More About Covid-19</span></a>
					<a href="https://www.who.int/"><span class="btn btn-primary banner-b2"><i class="fa fa-arrow-right"></i> Go WHO Website</span></a>
				</div>
			</div>
			<!-- Left Section End -->
